var CodChartRoadblocks = function(){
    ...
    me.render = function(){
        ...
        var roadblocks = Data.getFilteredRoadblocks();
        if (roadblocks.length === 0) roadblocks = Data.getRoadBlocks().features;
        
        var max = Data.getRoadBlocks().features.length;
        var current = roadblocks.length; 
        ...
        document.getElementById("legendRoadblocks").classList.add("show", "high");
